...
- `Réveille-moi le 26 Mars à 7 heures`<BR>
	- vous auriez pu dire aussi `Réveille-moi Lundi à 7 heures`<BR>
Avatar analyse la phrase et crée un scénario en relation:
- **La phrase**: 	`wake me up on march 26 at 7:00`
- **Le scénario**: 	
	- **Action:** `wake`
	- **When:**	  `Mon Mar 26 2018 07:00:00 GMT+0100 (Paris, Madrid)`
- **Résultat:**
	- `${ACTION}` le `${WHEN}`<BR>
...
Ce qui est intéressant à noter est que l'analyse de la phrase, le calcul de la Date (${WHEN}) ainsi que l'action (${ACTION}) et toutes les autres informations ne sont pas réalisées par le plugin mais par le [Traitement Naturel du Langage](https://github.com/spencermountain/compromise) intégré à Avatar.
