...
exports.default = function (state) {
	...
	return new Promise( function (resolve, reject) {
		...
		for (var rule in Config.modules.timer.rules) {
			var match = (0, _helpers.syntax)(state.sentence, Config.modules.timer.rules[rule]); 
			if (match) break;
		}
				
		if (state.debug) info('ActionTimer'.bold.yellow, rule.yellow );
